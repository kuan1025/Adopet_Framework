                ...
                $(function () {
                    ...
                    $(document).on("click", "#aCart", function () {
                        ...
                        if (!isNaN(num) && !isNaN(skuPrice)) {
                            ...
                            fetch("${pageContext.request.contextPath}/shCartAction/cart", {
                                method: 'POST',
                    ...
                    $(document).on("change", "#ck", function () {
                        ...
                        if (attrN2 != null && key1 != null && key2 != null) {
                            let arr = [key1, key2];
                            let data = { arr: arr,spuID, spuID };


                            fetch("${pageContext.request.contextPath}/cartAction/getPrcSk", {
                                method: 'POST',
                        ...
                        <div class="region region-navigation">
                            <div class="region--inner">
                                ...
                                <div class="profile-navigation">
                                    ...
                                    <!--購物車-->
                                    <a href="${pageContext.request.contextPath}/shCartAction/cart" class="nav-favorites-btn nav-cart-btn">
                                        <svg role="img" focusable="false">
                            ...
                            <div class="product__details__pic">
                                <div id="showOff" class="product__details__pic__item">
                                    <img class="product__details__pic__item--large"
                                        src="${pageContext.request.contextPath}/cartAction/getSpuPic/0/${spuID}"
                                        alt="">
                                </div>
                                ...
                                <div class="product__details__pic__slider owl-carousel">
                                    ...
                                    <img data-imgbigurl="${pageContext.request.contextPath}/cartAction/getSpuPic/0/${spuID}"
                                        src="${pageContext.request.contextPath}/cartAction/getSpuPic/0/${spuID}"
                                        alt="">
                                    <img data-imgbigurl="${pageContext.request.contextPath}/cartAction/getSpuPic/1/${spuID}"
                                        src="${pageContext.request.contextPath}/cartAction/getSpuPic/1/${spuID}"
                                        alt="">
                                    <img data-imgbigurl="${pageContext.request.contextPath}/cartAction/getSpuPic/2/${spuID}"
                                        src="${pageContext.request.contextPath}/cartAction/getSpuPic/2/${spuID}"
                                        alt="">
                                    <img data-imgbigurl="${pageContext.request.contextPath}/cartAction/getSpuPic/3/${spuID}"
                                        src="${pageContext.request.contextPath}/cartAction/getSpuPic/3/${spuID}"
                                        alt="">
                                </div>
