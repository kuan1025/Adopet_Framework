      ...
      <script>
        $(function () {
          ...
          $(document).on("click", ".pg", function () {
            ...
            $.ajax({
              url: "${pageContext.request.contextPath}/comAction/requirement",
              data: JSON.stringify({
                "lowC": lowC,
                "highC": highC,
                "prodName": prodName,
                      ...
                      <li class="menu-item menu-item--expanded">
                        ...
                        <div class="menu-inner menu-level-1">
                          <ul class="menu">
                            ...
                            <!--購物/二手商城 路徑-->
                            <li class="menu-item menu-item--expanded">
                              <a href="${pageContext.request.contextPath}/comAction/ecoMainP">購物</a>
                      ...
                      <div class="latest-prdouct__slider__item">
                        <a href="#" class="latest-product__item">
                          <div class="latest-product__item__pic">
                            ...
                            <img src="/Adopets/views/ecommerce/img_ecommerce/廣告1.jpeg"alt="">
                          </div>
                        ...
                        <a href="#" class="latest-product__item">
                          <div class="latest-product__item__pic">
                            <img src="/Adopets/views/ecommerce/img_ecommerce/廣告2.jpeg" alt="">
                          </div>
                          <div class="latest-product__item__text">
                            <h6>優質貓罐頭</h6>
                        ...
                        <a href="#" class="latest-product__item">
                          <div class="latest-product__item__pic">
                            <img src="/Adopets/views/ecommerce/img_ecommerce/廣告3.jpeg" alt="">
                          </div>
                          <div class="latest-product__item__text">
                            <h6>貓罐頭廣告</h6>
                            <span>$30.00</span>
                      ...
                      <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div id="mos" class="product__item mos">
                          <div class="product__item__pic ">
                            <!-- 路徑 -->
                            <img src="${pageContext.request.contextPath}/comAction/getPic/${skuPage.skuID}"
                              width="150px" height="150px" />
                            <ul class="product__item__pic__hover">

                              <li><a href="${pageContext.request.contextPath}/cartAction/getDetail/${skuPage.spuVO.spuID}"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                          </div>
                          <div class="product__item__text">

                            <h6><b><a
                                  href="${pageContext.request.contextPath}/cartAction/getDetail/${skuPage.spuVO.spuID}">${skuPage.spuVO.spuName}</a></b>
                            </h6>
